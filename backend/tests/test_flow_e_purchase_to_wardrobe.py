...
def test_migration_chain_has_a_single_head_at_current_head() -> None:
    ...
    # adds partner request-demo leads; the chain must stay linear with exactly one head.
    assert expected_head_revision() == "0018_partner_leads"
