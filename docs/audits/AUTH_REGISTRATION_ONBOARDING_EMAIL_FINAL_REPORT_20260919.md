...
| `739bf30` | `test(auth): share the SMTP test sink through a support module` (finalises this report) |

Branch head at hand-off: `739bf30` (6 commits, tree clean, 48 files / +6.3k lines vs `main @ 928e615`).
