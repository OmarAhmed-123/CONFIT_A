#!/usr/bin/env python3
"""
Download all model weights required for the FASHN segmentation-free fork.
...
NOTE (commercial fork): the upstream FashnHumanParser weights are NOT
downloaded. The parser is removed from this fork (segmentation-free-only).
"""
...
def download_human_parser() -> None:
    """No-op: the human parser is removed from this commercial fork."""
    print("Skipping FashnHumanParser download (removed in segmentation-free fork).")
